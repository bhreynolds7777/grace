...
const TOOLTIPS = {
  ...
  'Pressure':     'Stable or rising barometric pressure tends to produce the steadiest bite.',
  'Precipitation':'A light rain (0.05–0.20 in/hr) often triggers bass feeding.',
  'Inflow':       'River discharge as a proxy for current and turbidity. Normal flow is ideal.',
